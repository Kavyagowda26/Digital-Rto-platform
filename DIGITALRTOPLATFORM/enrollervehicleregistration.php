...
if(isset($_POST['submit']))
{
		...
		{
			echo "<script>alert('Vehicle Registration entry done successfully');</script>";
...
?>
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Vehicle Registration</li> <br><br>
    ...
    <div class="form-group">
      <label for="email">Full name of Registered owner:<span class="classvalidate" id="idownername"></span></label>
	...
	<div class="form-group">
      <label for="email">PAN Card No.: <span class="classvalidate" id="idpancardno"></span></label>
	...
	<div class="form-group">
      <label for="email">Vehicle Purchased From :<span class="classvalidate" id="idvehiclepurchasedfrom"></span></label>
      <input type="text" class="form-control" id="vehiclepurchasedfrom" placeholder="Vehicle Purchased From" name="vehiclepurchasedfrom">
    </div>
	<div class="form-group">
      <label for="email">Vehicle Detail:<span class="classvalidate" id="idvehicledetail"></span></label>
      <input type="text" class="form-control" id="vehicledetail" placeholder="Vehicle Detail:" name="vehicledetail">
    </div>
	<div class="form-group">
      <label for="email">Chasis No:<span class="classvalidate" id="idchasisno"></span></label>
      <input type="text" class="form-control" id="chasisno" placeholder="Enter Chasis No." name="chasisno">
    </div>
	<div class="form-group">
	...
	<div class="form-group">
      <label for="email">Fuel used in the engine:<span class="classvalidate" id="idfuel"></span></label>
      <input type="text" class="form-control" id="fuel" placeholder="Enter Fuel used in the engine" name="fuel">
    </div>
	<?php
	/*
	<div class="form-group">
	...
	*/
	?>
	<div class="form-group">
      <label for="email">Any Note:<span class="classvalidate" id="idnote"></span></label>
      <input type="text" class="form-control" id="note" placeholder="Enter Note" name="note">
    </div>
					
	<div class="form-group">
      <label for="email">Registration Type:<span class="classvalidate" id="idregtype"></span></label>
	...
	<div class="form-group">
      <label for="email">Vehicle No.:<span class="classvalidate" id="idvehicleno"></span></label>
      <input type="text" class="form-control" id="vehicleno" placeholder="Enter VehicleNo" name="vehicleno" readonly>
    </div>
