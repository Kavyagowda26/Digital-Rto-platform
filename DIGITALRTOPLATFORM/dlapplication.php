...
if(isset($_GET['llrid']))
{
	$sqledit ="SELECT * FROM llr WHERE llrid='$_GET[llrid]'";
...
if(isset($_POST['submit']))
{
	...
	{
		$sql="INSERT INTO drivinglicense ( enrollerid, llrid, dltype, stateid, cityid, vehicletypeid, photo, name, swdof, paddr, taddr, paddrduration, dob, birthplace, qualification, identificationmarks, bloodgroup, previousdl, applicationdate, document, status) VALUES 
		('$_SESSION[enrollerid]','$_GET[llrid]','New','$_POST[stateid]','$_POST[cityid]','$rsedit[vehicletypeid]','$filename','$_POST[name]','$_POST[swdof]','$_POST[paddr]','$_POST[taddr]','$_POST[paddrduration]','$_POST[dob]','$_POST[birthplace]',
		...
		if(mysqli_affected_rows($con) == 1)
		{
			echo "<script>alert('Driving license entry  done successfully.. The page will redirect to Payment gateway..');</script>";
			$insid = mysqli_insert_id($con);
			echo "<script>window.location='payment.php?insid=$insid&paidfor=DL';</script>";
		}
	}
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Driving License Registration(DL) Form</li> 
			<p class="mb-3" style="color:red;">Kindly fill all mandatory details to process Driving License Application..</p>
          </ul>
<form action="" method="post" enctype="multipart/form-data" onsubmit="return validateform()">
    ...
    <select name="stateid" class="form-control" readonly onchange="loadcity(this.value)">
	...
	<div class="form-group" id="ajaxcity">
      <label for="email">City:</label>
		<select name="cityid" class="form-control" readonly >
