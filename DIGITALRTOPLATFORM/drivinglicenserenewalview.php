...
{  
	$sql = "UPDATE drivinglicense SET status='Closed' WHERE drivinglicenseid='$rsexpired[0]'";
	...
	{		
		$sql = "UPDATE drivinglicense SET status='$_POST[appstatus]' WHERE drivinglicenseid='$_GET[insid]'";
		$qsql =mysqli_query($con,$sql);
	}
	echo "<script>alert('Driving license status updated successfully..');</script>";
	echo "<script>window.location='drivinglicenserenewalview.php?insid=$_GET[insid]';</script>";
}
?>
      <!--banner -->
      <!-- Slideshow 4 -->
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Driving License Renewal Application Form</li> 
          </ul>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="email" style="font-weight: bold;">Driving license expired on.:</label><br>
	<?php
	echo date("d-M-Y",strtotime($rsexpired['enddate']));
	?>
    </div>
...
?>	
	...
	?>
	<div class="form-group">
      <label for="email" style="font-weight: bold;"><span style="color:red;">Update Renewal application  status</span>:</label><br>
		<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Update Renewal application</button>
    </div>
	<?php
	}
	?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">DL Renewal Application</h4>
	...
	<div class="form-group">
		...
		<input type="text" name="dlno"  class="form-control" value="<?php echo $rsedit['dlno']; ?>" readonly>
    </div>
    <button type="submit" name="submit" class="btn btn-info">Issue Renewed driving license</button>
				<?php
				}
				?>
			</form>
