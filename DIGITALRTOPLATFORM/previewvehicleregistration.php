...
?>
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Vehicle Registration Detail</li> <br><br>
             <h5 class="mb-3" data-blast="color">Confirm Before making Payment</h5>
          </ul>
	...
	<div class="form-group">
      <label for="email">Date of birth <span style="color:red;">(As per Birth  certificate  /  School  certificate )</span></label>
	...
	<div class="form-group">
      <label for="email">Fuel used in the engine:</label>
	...
	*/
    ...
    <button type="submit" name="submit" class="btn btn-info">Update and Confirm</button>
