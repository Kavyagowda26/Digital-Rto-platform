...
if(isset($_GET['btnrc']))
{
	...
	{
		echo "<script>alert('Vehicle RC issued successfully..');</script>";
	}
}	
if(isset($_GET['verificationstatus']))
{
	...
	if(mysqli_affected_rows($con) ==1)
	{
		echo "<script>alert('Vehicle Registration verfication details updated successfully..');</script>";
	}
}
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Vehicle Registration Receipt</li> 
          </ul>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="email" style="font-weight: bold;">Full name of Registered owner:</label> <?php echo $rsedit['ownername']; ?>
    </div>
	...
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Duration of stay at the present address:</label>
	...
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Vehicle Purchased From :</label>
	...
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Chasis No:</label>
	...
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Fuel used in the engine:</label>
	...
	*/
	?>
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Any Note:</label>
      <?php echo $rsedit['note']; ?>
    </div>
					
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Registration Type:</label>
			<?php
	...
	<div class="form-group">
      <label for="email" style="font-weight: bold;">Vehicle No.:</label>
      <?php echo $rsedit['vehicleno']; ?>
    </div>
	<div class="form-group">
      <label for="email" style="font-weight: bold;color:green;">Date of Verification.:
      <?php echo date("d-M-Y",strtotime($rsedit['date'])); ?></label>
    </div>
...
<hr>	
  ...
  <hr>
  Note: Kindly visit RTO office to collect New RC card. 
  <hr>
<?php
...
<ol class="progtrckr" data-progtrckr-steps="4">
  ...
  <hr>
    ...
    <center><button type="button" name="button" class="btn btn-info"  onclick="printDiv('about')">Print</button></center>
