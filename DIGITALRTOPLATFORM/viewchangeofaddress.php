      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Address Change Request</li>
          </ul>
...
<tr>
	...
	<th>Action</th>
		...
		<tbody>
			<?php
					$sql = "SELECT drivinglicense.*,city.*,state.* FROM drivinglicense LEFT JOIN state ON drivinglicense.stateid=state.stateid LEFT JOIN city ON drivinglicense.cityid=city.cityid WHERE drivinglicense.dltype='Address Change' order by drivinglicense.drivinglicenseid DESC";
					$qsql= mysqli_query($con,$sql);
...
echo "<tr>
	...
	<a href='drivinglicense.php?delid=$rs[0]'  class='btn btn-danger' 
		onclick='return confirmdel()'>Delete</a><hr><a href='addresschangereceipt.php?insid=$rs[0]'  class='btn btn-warning' >View</a>
				</td>
</tr>";
					}
					?>
