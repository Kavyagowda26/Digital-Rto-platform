...
if(isset($_POST["btnlogin"]))
{
	...
	if(mysqli_num_rows($qsql) == 1)
	{
		...
		echo "<script>alert('Enroller logged in successfully...');</script>";
		echo "<script>window.location='userpanel.php';</script>";	
	}
	else
	{
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">ENROLLER LOGIN PANEL</li>
          </ul>
              ...
              <div class="row mt-lg-4 mt-3">
                ...
                <div class="col-md-7 latest-list">
                  <div class="about-jewel-agile-left">
                    <h5 class="mb-3" data-blast="color"> ENROLLER LOGIN PANEL</h5>
                    <p>
<form method="post" action="" onsubmit="return validateform()">
	...
	<button type="submit" name="btnlogin" class="btn btn-info">CLICK HERE TO LOGIN</button>
</form>
				  ...
				  <a href="changepass.php"><button type="button" name="loginbutton" class="btn btn-danger">FORGOT PASSWORD!!! </button></a>
					</p>
