      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
			...
			<p style="color:red;">Make payment to complete the application process..</p>
          </ul>
...
<table  class="table table-striped table-bordered">
	<tr>
		<th colspan="2" style="background-color: grey;color:white;"><?php echo $_GET['paidfor']; ?> Application detail</th>
	</tr>
	...
	<tr>
		<th colspan="2" style="background-color: grey;color:white;">Cost</th>
	</tr>
...
<form action="" method="post" onsubmit="return validateform()">
    ...
    <div class="form-group">
	  ...
	  <?php
	  $arr = array("VISA","Master Card","Rupay","Credit card");
	  foreach($arr as $val)
	  {
    ...
    <div class="form-group">
      <label for="email">Card Holder:<span class="classvalidate" id="idcardholder"></span></label>
      <input type="text" class="form-control" id="cardholder" placeholder="Enter Card Holder" name="cardholder">
    </div>
	
		
    <div class="form-group">
      <label for="email">Card number:<span class="classvalidate" id="idcardnumber"></span></label>
      <input type="text" class="form-control" id="cardnumber" placeholder="Enter Card number" name="cardnumber">
    </div>
	
		
    <div class="form-group">
      <label for="email">Card expires on:<span class="classvalidate" id="idexpireson"></span></label>
      <input type="month" min="<?php echo date("Y-m"); ?>" class="form-control" id="expireson" placeholder="Enter Expiry date" name="expireson">
    </div>
	
		
    <div class="form-group">
      <label for="email">CVV number:<span class="classvalidate" id="idcvvnumber"></span></label>
