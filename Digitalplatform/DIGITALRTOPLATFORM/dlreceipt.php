      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Driving License Application Payment Receipt</li> 
          </ul>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="email" style="font-weight: bold;">Driving license for:</label><br>
	 <?php
...
?>	
  ...
  <hr>
  Note: you need to visit RTO office to verify and test your driving license application. 
  <hr>
